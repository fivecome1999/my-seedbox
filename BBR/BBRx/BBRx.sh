...
case "$ID:${VERSION_ID%%.*}" in
    debian:12)
        bbrx_source_url="https://raw.githubusercontent.com/fivecome1999/my-seedbox/main/BBR/BBRx/tcp_bbrx.c"
        ;;
    debian:13)
        bbrx_source_url="https://raw.githubusercontent.com/fivecome1999/my-seedbox/main/BBR/BBRx/tcp_bbrx_debian13.c"
        ;;
    *)
